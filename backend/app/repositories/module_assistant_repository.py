...
class ModuleAssistantRepository:
    def __init__(self, database: Database):
        ...
        self.sessions = database["module_assistant_sessions"]
        self.messages = database["module_assistant_messages"]
        self._ensure_indexes()

    def _ensure_indexes(self) -> None:
        self.sessions.create_index("session_id", unique=True)
        self.sessions.create_index([("module_id", 1), ("user_id", 1)])
        self.messages.create_index([("session_id", 1), ("created_at", 1)])
        self.messages.create_index([("module_id", 1), ("created_at", -1)])
    ...
    async def get_module(self, module_id: str) -> Optional[Dict[str, Any]]:
        return self.modules.find_one(self._id_filter(module_id))
