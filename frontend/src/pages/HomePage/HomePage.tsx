...
function HomePage() {
	...
	return (
		<main className="home-scroll relative isolate min-h-screen overflow-x-hidden bg-[#fffdf8] text-[#111111] lg:h-screen lg:snap-y lg:snap-mandatory lg:overflow-y-auto lg:scroll-smooth">
			<HomeBackground />
