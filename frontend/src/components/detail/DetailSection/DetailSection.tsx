...
function DetailSection({
	...
	return (
		<section className="overflow-hidden rounded-[28px] border border-[#eadfce]/80 bg-[#fffdf8]/68 p-6 shadow-[0_16px_42px_rgba(84,59,33,0.08)] backdrop-blur-xl sm:p-7 lg:p-8">
			<div className="mb-7">
				{eyebrow && (
