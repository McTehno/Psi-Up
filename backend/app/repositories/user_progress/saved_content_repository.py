...
class SavedContentRepository:
    ...
    Shranjene vsebine so znotraj users dokumenta:

    users.progress.saved.learning_path_ids
    users.progress.saved.module_ids
    users.progress.saved.learning_unit_ids
    """
    ...
    def _get_saved_field_name(self, content_type: str) -> Optional[str]:
        """
        Vrne ime nested polja za shranjene vsebine glede na tip vsebine.
        """

        mapping = {
            "learning_path": "progress.saved.learning_path_ids",
            "module": "progress.saved.module_ids",
            "learning_unit": "progress.saved.learning_unit_ids",
        }
